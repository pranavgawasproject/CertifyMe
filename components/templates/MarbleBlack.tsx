...
function MarbleBlack({ data, logoUrl }: TemplateProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: '1.15cqw', color: '#BFA181', maxWidth: '65%', lineHeight: 1.6, marginBottom: '2%' }}>
        for distinguished achievement in
        <div style={{ fontSize: '1.7cqw', color: '#D4AF37', marginTop: '0.5%', fontStyle: 'italic' }}>
          {event || 'Event Name'}
        </div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '70%', marginTop: 'auto', marginBottom: '3%' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '1.5cqw', fontFamily: '"Dancing Script", cursive', color: '#D4AF37' }}>
