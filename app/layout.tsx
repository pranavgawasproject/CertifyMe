...
/** Site-wide structured data: Organization + WebApplication (no fabricated ratings/reviews). */
const jsonLd = {
  ...
  '@graph': [
    {
      ...
      description:
        'Free online certificate generator for completion, achievement, and award certificates.',
    },
    {
      '@type': 'WebSite',
      '@id': `${SITE_URL}/#website`,
