...
function PureMonochrome({ data, logoUrl }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        fontSize: '0.85vw', letterSpacing: '0.6em', textTransform: 'uppercase',
        color: '#000', marginBottom: '4%', fontWeight: 500,
      }}>
        Certificate of Achievement
      </div>

      <div style={{ fontSize: '0.95vw', color: '#666', marginBottom: '2%' }}>
        This is to certify that
      </div>

      <div style={{
        fontSize: '3.6vw', fontWeight: 300, color: '#000',
      ...
      <div style={{ fontSize: '1vw', color: '#333', maxWidth: '65%', lineHeight: 1.6, marginBottom: '4%' }}>
        has successfully completed
        <div style={{ fontSize: '1.5vw', color: '#000', marginTop: '1%', fontWeight: 500 }}>
          {event || 'Event Name'}
        </div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', width: '70%', marginTop: 'auto' }}>
        <div style={{ textAlign: 'left' }}>
          <div style={{ fontSize: '1.3vw', color: '#000', fontWeight: 300, fontStyle: 'italic' }}>
            {signature || issuer || 'Issuer'}
          </div>
          <div style={{ width: '120px', height: '1px', background: '#000', margin: '8px 0 4px' }} />
          <div style={{ fontSize: '0.7vw', letterSpacing: '0.25em', textTransform: 'uppercase', color: '#666' }}>
            {issuer || 'Issuing Authority'}
          </div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontSize: '1vw', color: '#000', fontWeight: 500 }}>{date || 'Date'}</div>
          <div style={{ width: '120px', height: '1px', background: '#000', margin: '8px 0 4px', marginLeft: 'auto' }} />
          <div style={{ fontSize: '0.7vw', letterSpacing: '0.25em', textTransform: 'uppercase', color: '#666' }}>Date</div>
        </div>
      </div>
    </div>
  );
